...
public class GeometryUtils {
  ...
  public static LineString getLineString(List<TrackPointPayload> points) {
  ...
  public static List<TrackPointPayload> getPoints(LineString lineString) {
    return Stream.of(lineString.getCoordinates())
        .map(coordinate -> TrackPointPayload.builder()
            .lat(coordinate.getX())
            .lon(coordinate.getY())
            .build())
